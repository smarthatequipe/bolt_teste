...
// Expanded blog posts with full content structure
...
// Export a simplified version for the blog listing page
export const blogPostsForListing = blogPosts.map(post => ({
  title: post.title,
  slug: post.slug,
