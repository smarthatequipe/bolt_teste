          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <option value="seo">SEO e Marketing de Conteúdo</option>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-1 text-gray-600">
                    <a href="mailto:contato@fitnesshub.com.br" className="hover:text-blue-600">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-1 text-gray-600">
                    <a href="tel:+551199999999" className="hover:text-blue-600">
                      (11) 9999-9999
                    </a>
                  </p>
                </div>
